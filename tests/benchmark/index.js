const { createDb } = require('../../packages/core/src');
const { MemoryAdapter } = require('../../packages/adapters/memory/src');
const { SQLiteAdapter } = require('../../packages/adapters/sqlite/src');
...
async function benchmarkMemoryAdapter(documentCounts) {
...
async function benchmarkSQLiteAdapter(documentCounts) {
...
function printResults(memoryResults, sqliteResults, documentCounts) {
